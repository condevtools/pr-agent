...
export default function BenefitsSection() {
  ...
  return (
    <section id="benefits" className="bg-black py-20 md:py-24 lg:py-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          <div className="flex flex-col gap-8">
            <div data-gsap="reveal">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white/40 leading-tight mt-1">
                {copy.subtitle}
              </h2>
            </div>

            <div data-gsap="cards" className="flex flex-wrap gap-2.5">
              {tags.map((tag) => (
                <span
                  key={tag}
          ...
          <div className="flex flex-col gap-4">
            <div data-gsap="reveal" className="bg-[#080808] border border-white/8 p-6 sm:p-8 flex flex-col gap-4">
            ...
            <div data-gsap="cards" className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {copy.cards.map((card) => (
