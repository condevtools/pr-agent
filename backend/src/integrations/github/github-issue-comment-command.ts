    ...
    if (!reviewBehavior.askCommandEnabled) {
      await params.context.octokit.issues.createComment({
        ...
        body: buildCommandDisabledByPolicyMessage({
          command: "ask",
          policyPath: ".pr-agent.yml -> review.askCommandEnabled=false",
          locale,
        }),
      });
      ...
      async (feedbackCommand) => {
        ...
        if (!reviewBehavior.feedbackCommandEnabled) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandDisabledByPolicyMessage({
              command: "feedback",
              policyPath: ".pr-agent.yml -> review.feedbackCommandEnabled=false",
              locale,
            }),
          });
      ...
      async (describe) => {
        ...
        if (!reviewBehavior.describeEnabled) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandDisabledByPolicyMessage({
              command: "describe",
              policyPath: ".pr-agent.yml -> review.describeEnabled=false",
              locale,
            }),
          });
        ...
        if (describe.apply && !reviewBehavior.describeAllowApply) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandApplyDisabledByPolicyMessage({
              command: "describe",
              policyPath: ".pr-agent.yml -> review.describeAllowApply=false",
              locale,
            }),
          });
      ...
      async (checksCommand) => {
        ...
        if (!reviewBehavior.checksCommandEnabled) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandDisabledByPolicyMessage({
              command: "checks",
              policyPath: ".pr-agent.yml -> review.checksCommandEnabled=false",
              locale,
            }),
          });
        ...
        if (!reviewBehavior.generateTestsCommandEnabled) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandDisabledByPolicyMessage({
              ...
              policyPath: ".pr-agent.yml -> review.generateTestsCommandEnabled=false",
              locale,
            }),
          });
      ...
      async (changelogCommand) => {
        ...
        if (!reviewBehavior.changelogCommandEnabled) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandDisabledByPolicyMessage({
              command: "changelog",
              policyPath: ".pr-agent.yml -> review.changelogCommandEnabled=false",
              locale,
            }),
          });
        ...
        if (changelogCommand.apply && !reviewBehavior.changelogAllowApply) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandApplyDisabledByPolicyMessage({
              command: "changelog",
              policyPath: ".pr-agent.yml -> review.changelogAllowApply=false",
              locale,
            }),
          });
      ...
      async (improveCommand) => {
        ...
        if (!reviewBehavior.improveCommandEnabled) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandDisabledByPolicyMessage({
              command: "improve",
              policyPath: ".pr-agent.yml -> review.improveCommandEnabled=false",
              locale,
            }),
          });
      ...
      async (addDocCommand) => {
        ...
        if (!reviewBehavior.addDocCommandEnabled) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandDisabledByPolicyMessage({
              command: "add_doc",
              policyPath: ".pr-agent.yml -> review.addDocCommandEnabled=false",
              locale,
            }),
          });
        ...
        if (!reviewBehavior.askCommandEnabled) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildReflectDependsOnAskMessage({
              askPolicyPath: ".pr-agent.yml -> review.askCommandEnabled=false",
              locale,
            }),
          });
      ...
      async () => {
        ...
        if (!reviewBehavior.implementCommandEnabled) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandDisabledByPolicyMessage({
              command: "implement",
              policyPath: ".pr-agent.yml -> review.implementCommandEnabled=false",
              locale,
            }),
          });
        ...
        if (!reviewBehavior.customPromptCommandEnabled) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandDisabledByPolicyMessage({
              ...
              policyPath: ".pr-agent.yml -> review.customPromptCommandEnabled=false",
              locale,
            }),
          });
      ...
      async (cmd) => {
        ...
        if (!reviewBehavior.helpDocsCommandEnabled) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandDisabledByPolicyMessage({
              command: "help_docs",
              policyPath: ".pr-agent.yml -> review.helpDocsCommandEnabled=false",
              locale,
            }),
          });
      ...
      async () => {
        ...
        if (!reviewBehavior.analyzeCommandEnabled) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandDisabledByPolicyMessage({
              command: "analyze",
              policyPath: ".pr-agent.yml -> review.analyzeCommandEnabled=false",
              locale,
            }),
          });
      ...
      async (cmd) => {
        ...
        if (!reviewBehavior.complianceCommandEnabled) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandDisabledByPolicyMessage({
              command: "compliance",
              policyPath: ".pr-agent.yml -> review.complianceCommandEnabled=false",
              locale,
            }),
          });
        ...
        if (!reviewBehavior.autoLabelEnabled) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandDisabledByPolicyMessage({
              ...
              policyPath: ".pr-agent.yml -> review.autoLabelEnabled=false",
              locale,
            }),
          });
        ...
        if (!reviewBehavior.similarCodeCommandEnabled) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandDisabledByPolicyMessage({
              ...
              policyPath: ".pr-agent.yml -> review.similarCodeCommandEnabled=false",
              locale,
            }),
          });
        ...
        if (!reviewBehavior.autoApproveCommandEnabled) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandDisabledByPolicyMessage({
              ...
              policyPath: ".pr-agent.yml -> review.autoApproveCommandEnabled=false",
              locale,
            }),
          });
        ...
        if (!reviewBehavior.scanRepoDiscussionsCommandEnabled) {
          await params.context.octokit.issues.createComment({
            ...
            body: buildCommandDisabledByPolicyMessage({
              ...
              policyPath: ".pr-agent.yml -> review.scanRepoDiscussionsCommandEnabled=false",
              locale,
            }),
          });
